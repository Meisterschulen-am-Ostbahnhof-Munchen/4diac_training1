...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(DataMask_M1), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 5, 0, 
		XYREF(Bargraph_Hysterese, 100, 50),
		XYREF(Container_Schwellwerte, 128, 38),
		XYREF(InputNumber_MID, 176, 50),
		XYREF(InputNumber_DEAD, 176, 100),
		XYREF(InputNumber_HYSTERESIS, 176, 150),
	ID(Container_Schwellwerte), TYPEID_CONTAINER, WORD(28), WORD(210), 0, 5, 0, 
		XYREF(Polygon_MID, 0, 93),
		XYREF(Polygon_MID_PLUS_DEAD, 0, 65),
		XYREF(Polygon_MID_MINUS_DEAD, 0, 121),
		XYREF(Polygon_MID_PLUS_DEAD_HYST, 0, 28),
		XYREF(Polygon_MID_MINUS_DEAD_HYST, 0, 158),
	...
	ID(Polygon_MID_MINUS_DEAD_HYST), TYPEID_OUTPOLY, WORD(25), WORD(25), 
		...
		WORD(24), WORD(0), 
		WORD(24), WORD(24), 
	ID(Bargraph_Hysterese), TYPEID_OUTLINBAR, WORD(28), WORD(186), COLOR_BLACK, COLOR_RED, 39, 11, 
		WORD(0), WORD(100), ID(NumberVariable_Istwert), WORD(50), ID(NumberVariable_MID), WORD(0), 0, 
	...
	ID(NumberVariable_Istwert), TYPEID_VARNUM, LONG(50UL), 
