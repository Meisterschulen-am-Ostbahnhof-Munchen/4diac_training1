...
for %%f in (*.png) do (
    ...
    magick %%f -shave 2x2 -define png:exclude-chunks=date ..\img_cropped\%%f 
    magick identify ..\img_cropped\%%f
    echo 2. resize to 64x64
    magick ..\img_cropped\%%f -resize 64x64 -define png:exclude-chunks=date ..\img_resized\%%f  
    magick identify ..\img_resized\%%f
    echo 3. make monochrome PNG
    magick ..\img_resized\%%f -monochrome -define png:exclude-chunks=date ..\img_monochrome\%%f 
