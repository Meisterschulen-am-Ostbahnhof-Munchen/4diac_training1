...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(DataMask), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 19, 0, 
		...
		XYREF(InputNumber_PWM_DUTY_OUT, 240, 450),
		XYREF(InputNumber_THRESHOLD, 70, 400),
		XYREF(InputNumber_HYSTERESIS, 70, 450),
		XYREF(OutputString_THRESHOLD, 70, 390),
		XYREF(OutputString_HYSTERESIS, 70, 440),
	ID(DataMask_1001), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 1, 0, 
		XYREF(InputNumber_PWM_DUTY_NegScale, 240, 240),
	...
	ID(InputNumber_PWM_DUTY_OUT), TYPEID_INNUM, WORD(150), WORD(30), COLOR(193), ID(FontAttributes_16x16), 0, 
		ID(ID_NULL), LONG(0UL), LONG(0UL), LONG(8191UL), LONG(0L), 0x40, 0x06, 0x48, 0x3C, 3, 0, 1, 1, 0, 
	ID(InputNumber_THRESHOLD), TYPEID_INNUM, WORD(150), WORD(30), COLOR(193), ID(FontAttributes_16x16), 0, 
		ID(ID_NULL), LONG(0UL), LONG(0UL), LONG(8191UL), LONG(0L), 0x40, 0x06, 0x48, 0x3C, 3, 0, 1, 1, 0, 
	ID(InputNumber_HYSTERESIS), TYPEID_INNUM, WORD(150), WORD(30), COLOR(193), ID(FontAttributes_16x16), 0, 
		ID(ID_NULL), LONG(0UL), LONG(0UL), LONG(8191UL), LONG(0L), 0x40, 0x06, 0x48, 0x3C, 3, 0, 1, 1, 0, 
	ID(InputNumber_PWM_DUTY_NegScale), TYPEID_INNUM, WORD(150), WORD(30), COLOR(193), ID(FontAttributes_16x16), 0, 
		ID(NumberVariable_PWM_DUTY_NegScale), LONG(123UL), LONG(0UL), LONG(8191UL), LONG(-8191L), 0x29, 0x06, 0x48, 0xBC, 3, 0, 1, 1, 0, 
	ID(OutputString_THRESHOLD), TYPEID_OUTSTR, WORD(150), WORD(10), COLOR_WHITE, ID(FontAttributes_small), 0,
		ID(ID_NULL), 1, WORD(9), 'T', 'H', 'R', 'E', 'S', 'H', 'O', 'L', 'D', 0,
	ID(OutputString_HYSTERESIS), TYPEID_OUTSTR, WORD(150), WORD(10), COLOR_WHITE, ID(FontAttributes_small), 0,
		ID(ID_NULL), 1, WORD(10), 'H', 'Y', 'S', 'T', 'E', 'R', 'E', 'S', 'I', 'S', 0,
	...
	ID(NumberVariable_PWM_DUTY_NegScale), TYPEID_VARNUM, LONG(0UL), 
	...
	ID(FontAttributes_small), TYPEID_FONTATTR, COLOR_BLACK, 0, 0, 0, 0, 
