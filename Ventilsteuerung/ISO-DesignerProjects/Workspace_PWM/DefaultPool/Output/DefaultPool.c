...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(DataMask_1000), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 7, 0, 
	...
	ID(InputNumber_PWM_DUTY), TYPEID_INNUM, WORD(150), WORD(30), COLOR(193), ID(FontAttributes_16x16), 0, 
		ID(NumberVariable_PWM_DUTY), LONG(123UL), LONG(0UL), LONG(8191UL), LONG(0L), 0x40, 0x06, 0x48, 0x3C, 3, 0, 1, 1, 0, 
	...
	ID(OutputNumber_8129), TYPEID_OUTNUM, WORD(150), WORD(40), COLOR_WHITE, ID(FontAttributes_12x16), 1,
		ID(ID_NULL), LONG(8192UL), LONG(0L), FLOAT_1, 0, 0, 1, 0,
	ID(NumberVariable_PWM_DUTY), TYPEID_VARNUM, LONG(0UL), 
