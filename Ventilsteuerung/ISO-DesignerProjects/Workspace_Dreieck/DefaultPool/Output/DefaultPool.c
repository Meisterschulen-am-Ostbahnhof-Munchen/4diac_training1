...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(DataMask_M1), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 4, 0, 
		...
		XYREF(LinearBargraph_18000, 198, 185),
		XYREF(InputNumber_9000, 192, 230),
	...
	ID(InputNumber_9000), TYPEID_INNUM, WORD(96), WORD(40), COLOR_WHITE, ID(FontAttributes_Werte), 0, 
	...
	ID(Polygon_Bargraph_Mittelmarker), TYPEID_OUTPOLY, WORD(13), WORD(13), 
		...
		WORD(12), WORD(12), 
		WORD(0), WORD(12), 
	ID(LinearBargraph_18000), TYPEID_OUTLINBAR, WORD(84), WORD(14), COLOR_BLACK, COLOR_RED, 55, 11, 
