...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_DefaultPool[] = {
	...
	ID(WorkingSet), TYPEID_WORKSET, COLOR_SILVER, 1, ID(DataMask_M1), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_M1), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 9, 0, 
		...
		XYREF(InputNumber_Messwert, 192, 340),
		XYREF(OutputString_UP, 300, 340),
		XYREF(OutputString_DOWN, 300, 370),
	...
	ID(InputNumber_Messwert), TYPEID_INNUM, WORD(96), WORD(40), COLOR_WHITE, ID(FontAttributes_Werte), 0, 
		ID(NumberVariable_Messwert), LONG(500UL), LONG(0UL), LONG(1000UL), LONG(0L), FLOAT_1, 0, 0, 1, 1, 0, 
	...
	ID(OutputString_UP), TYPEID_OUTSTR, WORD(80), WORD(24), COLOR_WHITE, ID(FontAttributes_6x8), 2,
		ID(ID_NULL), 1, WORD(2), 'U', 'P', 0,
	ID(OutputString_DOWN), TYPEID_OUTSTR, WORD(80), WORD(24), COLOR_WHITE, ID(FontAttributes_6x8), 2,
		ID(ID_NULL), 1, WORD(4), 'D', 'O', 'W', 'N', 0,
	...
	ID(NumberVariable_Messwert), TYPEID_VARNUM, LONG(500UL), 
