...
del ..\4diacIDE-workspace\test_AX\Uebungen\const\UT\Ventilsteuerung\Workspace\DefaultPool.gcf
...
del ..\4diacIDE-workspace\test_AX\Uebungen\const\UT\Ventilsteuerung\Workspace_TECU\DefaultPool_TECU.gcf
...
del ..\4diacIDE-workspace\test_AX\Uebungen\const\UT\Ventilsteuerung\Workspace_PWM\DefaultPool_PWM.gcf
