<template>
  <div class="app">
    <header>
      <h1>APIXON Node 20 — AI Calibrate 3P Test</h1>
    ...
    <p class="calib-note">
      3-Punkt-Kalibrierung (Minimum „MIN“ / Mitte „MID“ / Maximum „MAX“) kann sowohl über die
      3 Tasten je Kanal am ISOBUS-VT-Bildschirm als auch hier im Web-Client ausgelöst werden —
      Referenzwert anlegen, dann die passende Taste drücken (Reihenfolge frei wählbar, jeder
      Punkt wird unabhängig gespeichert).
    </p>
