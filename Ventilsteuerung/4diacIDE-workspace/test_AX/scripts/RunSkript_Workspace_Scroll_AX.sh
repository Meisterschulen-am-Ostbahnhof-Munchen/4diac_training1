...
run_gcf --oldfile ISO-DesignerProjects/Workspace_Scroll/DefaultPool/Output/DefaultPool.iop.h --newfolder 4diacIDE-workspace/test_AX/Uebungen/const/UT/Scroll/ --newfile DefaultPool --package Uebungen::const::UT::Scroll --jopfile ISO-DesignerProjects/Workspace_Scroll/DefaultPool/DefaultPool.jop
