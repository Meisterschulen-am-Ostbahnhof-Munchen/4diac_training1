...
cd /d "%~dp0"
python ..\..\..\scripts_central\compile_iso_designer_project.py --pool-dir ISO-DesignerProjects\Workspace_PWM12\DefaultPool
...
if errorlevel 1 exit /b 1
python ..\..\..\scripts_central\list_mask_objects.py --pool-dir ISO-DesignerProjects\Workspace_PWM12\DefaultPool --emit-visibility ..\..\..\ISO-DesignerProjects\Workspace_PWM12\DefaultPool\Output\DefaultPool.vis.csv --emit-visibility-json ..\..\..\ISO-DesignerProjects\Workspace_PWM12\DefaultPool\Output\DefaultPool.vis.json
if errorlevel 1 exit /b 1
