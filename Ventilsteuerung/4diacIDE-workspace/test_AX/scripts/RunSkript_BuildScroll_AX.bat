...
cd /d "%~dp0"
python ..\..\..\scripts_central\compile_iso_designer_project.py --pool-dir ISO-DesignerProjects\Workspace_Scroll\DefaultPool
...
python ..\..\..\scripts_central\GcfScript.py --oldfile ISO-DesignerProjects\Workspace_Scroll\DefaultPool\Output\DefaultPool.iop.h --newfolder 4diacIDE-workspace\test_AX\Uebungen\const\UT\Scroll\ --newfile DefaultPool --package Uebungen::const::UT::Scroll --jopfile ISO-DesignerProjects\Workspace_Scroll\DefaultPool\DefaultPool.jop
if errorlevel 1 exit /b 1
