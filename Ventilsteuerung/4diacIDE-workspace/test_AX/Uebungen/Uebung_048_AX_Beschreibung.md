# Übung 048: Reine Event-Schrittkette 4-Kanal ENDLOS
...
Die Steuerung soll über den Baustein `sequence_E_04_loop_AX` realisiert werden.
...
- **Reset:** Zu jedem Zeitpunkt kann die Schrittkette über einen Reset (z.B. Taster `I6` oder Softkey) in den Ausgangszustand (Schritt 0) zurückgesetzt werden.

### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_048_AX` bzw. `Uebung_048` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_E_04_loop_AX` und konfigurieren Sie die Parameter.
