# Übung 044: Spiegelabfolge 5-Kanal mit Schrittkette ENDLOS
...
Die Steuerung soll über den Baustein `sequence_ET_05_loop_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_044_AX` bzw. `Uebung_044` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_ET_05_loop_AX` und konfigurieren Sie die Parameter.
