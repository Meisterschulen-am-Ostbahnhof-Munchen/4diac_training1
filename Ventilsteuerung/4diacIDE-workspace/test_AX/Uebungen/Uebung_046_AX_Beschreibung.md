# Übung 046: Ablaufsteuerung 8-Kanal ENDLOS (Event & Zeit)
...
Die Steuerung soll über den Baustein `sequence_ET_08_loop_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_046_AX` bzw. `Uebung_046` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_ET_08_loop_AX` und konfigurieren Sie die Parameter.
