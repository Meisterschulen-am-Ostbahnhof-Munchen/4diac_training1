# Übung 064: Musterschrittkette 8-Kanal ENDLOS
...
Die Steuerung soll über den Baustein `sequence_Pattern_08_08_loop_AX` realisiert werden.
...
- **Übergänge:** Die Schrittübergänge schalten Bit-Muster (Nockenwalze) zeitgesteuert durch.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_064_AX` bzw. `Uebung_064` an.
