# Übung 062: Reine Zeitsteuerung 5-Kanal
...
Die Steuerung soll über den Baustein `sequence_T_05_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_062_AX` bzw. `Uebung_062` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_T_05_AX` und konfigurieren Sie die Parameter.
