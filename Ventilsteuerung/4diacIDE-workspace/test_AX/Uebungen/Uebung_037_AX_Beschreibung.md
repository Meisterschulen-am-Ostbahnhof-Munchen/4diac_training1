# Übung 037: Spiegelabfolge V2 mit Schrittkette ENDLOS
...
Die Steuerung soll über den Baustein `sequence_ET_04_loop_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_037_AX` bzw. `Uebung_037` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_ET_04_loop_AX` und konfigurieren Sie die Parameter.
