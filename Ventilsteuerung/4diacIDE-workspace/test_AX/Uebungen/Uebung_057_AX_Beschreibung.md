# Übung 057: Reine Event-Schrittkette 5-Kanal
...
Die Steuerung soll über den Baustein `sequence_E_05_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_057_AX` bzw. `Uebung_057` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_E_05_AX` und konfigurieren Sie die Parameter.
