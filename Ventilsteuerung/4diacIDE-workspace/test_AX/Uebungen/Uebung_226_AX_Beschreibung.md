# Übung 226 AX: Split-Bargraph mit AR-Adapter
...
- Da hier - anders als bei 225b_AX mit seinem parallelen Istwert-Schreiben - nur **ein** Verbraucher
...
`Uebung_226_AX.SUB` — validiert gegen `subapptype.xsd`. Neuer Baustein:
