# Übung 063: Reine Zeitsteuerung 8-Kanal
...
Die Steuerung soll über den Baustein `sequence_T_08_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_063_AX` bzw. `Uebung_063` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_T_08_AX` und konfigurieren Sie die Parameter.
