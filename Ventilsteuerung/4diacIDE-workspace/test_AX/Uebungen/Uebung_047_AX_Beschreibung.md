# Übung 047: Reine Event-Schrittkette 4-Kanal
...
Die Steuerung soll über den Baustein `sequence_E_04_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_047_AX` bzw. `Uebung_047` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_E_04_AX` und konfigurieren Sie die Parameter.
