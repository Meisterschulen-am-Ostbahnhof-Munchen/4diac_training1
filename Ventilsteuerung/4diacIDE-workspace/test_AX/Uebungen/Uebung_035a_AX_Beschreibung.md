# Übung 035a: Lauflicht 4 reine Zeitsteuerung
...
Die Steuerung soll über den Baustein `sequence_T_04_loop_AX` realisiert werden.
...
### Arbeitsauftrag
1. Öffnen Sie das 4diac-Projekt und legen Sie die SubApp `Uebung_035a_AX` bzw. `Uebung_035a` an.
2. Platzieren Sie den Sequenzer-Baustein `sequence_T_04_loop_AX` und konfigurieren Sie die Parameter.
