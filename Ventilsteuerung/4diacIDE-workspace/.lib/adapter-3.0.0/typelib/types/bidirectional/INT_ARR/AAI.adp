...
<AdapterType Name="AAI" Comment="bidirectional Adapter Interface for 1 Event and 1 Int Array">
	...
	<InterfaceList>
		...
		<InOutVars>
			<VarDeclaration Name="D1" Type="INT" Comment="Indication (or Request) Data from Plug" ArraySize="*"/>
		</InOutVars>
	</InterfaceList>
