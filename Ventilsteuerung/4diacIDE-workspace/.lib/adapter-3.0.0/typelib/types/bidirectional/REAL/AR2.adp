...
<AdapterType Name="AR2" Comment="bidirectional Adapter Interface for 1 Event and 1 Real">
	...
	<InterfaceList>
		...
		<InputVars>
			<VarDeclaration Name="DI1" Type="REAL" Comment="Request (or Indication) to Socket"/>
		</InputVars>
		<OutputVars>
			<VarDeclaration Name="DO1" Type="REAL" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
</AdapterType>
