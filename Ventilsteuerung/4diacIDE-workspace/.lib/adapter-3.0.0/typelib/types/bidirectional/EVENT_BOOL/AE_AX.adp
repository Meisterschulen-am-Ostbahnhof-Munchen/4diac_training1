...
<AdapterType Name="AE_AX" Comment="bidirectional Adapter Interface for 1 Event (forward) and 1 Bool (backward, AX-style)">
	...
	<InterfaceList>
		...
		<EventOutputs>
			<Event Name="E1" Type="Event" Comment="Request (or Indication)">
			</Event>
		</EventOutputs>
		<InputVars>
